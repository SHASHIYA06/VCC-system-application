...
const systemNav = [
  ...
  { name: 'Doors', href: '/systems/DOOR', icon: DoorOpen, color: 'cyan' },
  ...
  { name: 'APS', href: '/systems/APS', icon: Battery, color: 'amber' },
];
...
const dataNav = [
  ...
  { name: 'Cars', href: '/cars/DMC', icon: Car },
];
